...
// HEROES TYPES
export const MINOR_FIGURE_BACKGROUND = COLOR_1;
export const PRIMORDIAL_DEITY_BACKGROUND = COLOR_24;
export const DEMIGOD_BACKGROUND = COLOR_4;
export const GIANT_BACKGOURND = COLOR_5;
export const TITAN_BACKGROUND = COLOR_6;
export const KING_BACKGROUND = COLOR_7;
export const SEA_DEITY_BACKGROUND = COLOR_10;
export const DEITY_BACKGROUND = COLOR_11;
export const CHTHONIC_DEITY_BACKGROUND = COLOR_12;
...
export const DEIFIED_MORTAL_BACKGROUND = COLOR_17;
export const HEALTH_DEITY_BACKGROUND = COLOR_18;
export const CREATURE_BACKGROUND = COLOR_19;
export const AMAZON_BACKGROUND = COLOR_20;
export const SEER_ORACLE_BACKGROUND = COLOR_21;
